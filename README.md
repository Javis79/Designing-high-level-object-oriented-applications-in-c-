# Designing-and-creating-high-level-object-oriented-applications-Homeworks
...
1. Clone the repository:
   ```sh
   git clone https://github.com/Javis79/Designing-and-creating-high-level-object-oriented-applications-c-.git
   ```
